...
$secretKey = '6LcflSkqAAAAAPaGGvZ6M62VL7SWXSKkEmQF9k8k';
...
if (isset($_POST['inn_submit_frm'])) {
    ...
    $mail->SetFrom('smtp@aspireindia.com', "Code Superb Pvt. Ltd.");
    $mail->AddReplyTo("jhaabhishek88821@gmail.com", "Code Superb Pvt. Ltd."); 
    $mail->AddAddress('jhaabhishek88821@gmail.com',"Code Superb Pvt. Ltd.");

    $mail->Subject = "Contact Enquiry";
    $mail->AltBody = "Message here...";
    $message = "<html><body>";
    $message .= '<h2 style="background:linear-gradient(145deg, #b753ff , #00efff); color:#fff; padding:20px 20px; border-bottom:2px solid black;">Code Superb</h2>';
    ...
    $message .= "<tr><td><strong>Mobile No.:</strong> </td><td>" . htmlspecialchars($mobile) . "</td></tr>";
    $message .= "<tr style='background: #eee;'><td><strong>E-mail address:</strong> </td><td>" . htmlspecialchars($email) . "</td></tr>";
    $message .= "<tr><td><strong>Purpose:</strong> </td><td>" . htmlspecialchars($purpose) . "</td></tr>";
    $message .= "<tr style='background: #eee;'><td><strong>Message:</strong> </td><td>" . htmlspecialchars($messages) . "</td></tr>";
    $message .= '</table>';
    $message .= '</body></html>';
        ...
        if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
            ...
            if ($responseData->success) {
                ...
                if ($mail->send()) {
                    ...
                    echo '<div style="background-color: #000; height: 100%; display: flex; align-items: center; justify-content: center;">';
                    ...
                    echo '</div>';
                    echo '</body>';
                    header("Refresh: 1; URL=https://codesuperb.com/");
                } else {
